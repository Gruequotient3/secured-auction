...
export function rsaEncText(message, {e, n}){
    ...
    return rsaEnc(encode, {e, n});
}

export function rsaEnc(message, {e, n}){;
    if (message >= n) {
        console.log("Le message ne remplit pas les conditions de chiffrement");
        return -1;
    }
    return rsa(message, {e, n});
}

export function rsaDecText(message, {e, n}){
    if (message >= n){
        console.log("Le message ne remplit pas les conditions de déchiffrement");
        return -1;
    }
    let decode = bigIntDecode(rsa(message, {e, n}));
    return decode;
}

export function rsaDec(message, {e, n}){
    if (message >= n){
        console.log("Le message ne remplit pas les conditions de déchiffrement");
        return -1;
    }
    let decode = rsa(message, {e, n});
    return decode;
}
...
export function rsaVerify(message, signature, {e, n}){
    let hash = sha256(message);
    let verify = rsaDec(signature, {e, n}).toString(16); 
    return hash == verify;
}
...
export function bigIntDecode(value){
